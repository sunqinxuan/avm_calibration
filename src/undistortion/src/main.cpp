...
{   
	...
	ImageUndistortion image_undistort;
	ros::spin();
...
//	std::string cv_camera_topic="/cv_camera/image_raw";

//	ros::Subscriber sub_cam = nh.subscribe(cv_camera_topic, 7, &BagReader::callback_cam, this);
